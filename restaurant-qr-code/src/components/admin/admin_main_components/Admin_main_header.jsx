...
function Admin_main_header() {
  ...
  return (
    <header className="w-full bg-gradient-to-r from-green-200 to-blue-200 p-3 shadow-md sticky top-0 z-20">
      <div className="flex justify-between items-center pl-0 pr-4">
        <div className="flex items-center">
          ...
          />
          <span className="text-base md:text-lg lg:text-xl font-bold italic">
            DiamondBu
          </span>
        </div>
        <h1 className="text-lg md:text-xl lg:text-2xl font-bold italic absolute left-1/2 transform -translate-x-1/2">
          Admin
        </h1>
        <button
